...
class _LoginSignupScState extends State<LoginSignupSc> {
  ...
  void _gotoScreen(String text) async {
    setState(() {
      showSpinner = true;
    });
        ...
        child: GestureDetector(
          ...
          child: Stack(
            children: [
              ...
              //배경
              AnimatedPositioned(
                  duration: Duration(milliseconds: Palette.durationTime),
                  curve: Curves.easeIn,
                  top: 180,
                                  ...
                                  children: [
                                    TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty ||
                                            value!.length < 4) {
                                          return 'Please enter at user name';
                                        }
                                        return null;
                                      },
                                  ...
                                  children: [
                                    TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty ||
                                            !value!.contains('@')) {
                                          return 'Please enter a invalid e-mail address';
                                        }
                                        return null;
                                      },
                                      decoration: InputDecoration(
